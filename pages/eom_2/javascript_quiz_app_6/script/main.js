...
let mainQuestions = [
    {
        text: 'Выберите, на каком этапе происходит анализ результатов и внесение корректировок в процесс разработки ПО:',
        right: [2],
        type: 1,
        points: 100,
        answers: ['анализ требований', 'разработка', 'тестирование', 'проектирование',],
    },
];
