...
let mainQuestions = [
    {
        text: 'Отметьте, для чего необходим этап анализа требований:',
        right: [2],
        type: 1,
        points: 100,
        answers: ['определить соответствие требований и затрат', 'определить возможности разработчиков', 'определить потребности заказчика и согласовать требования', 'определить высокоуровневую архитектуру системы',],
    },
];
