...
let mainQuestions = [
    {
        text: ' Вберите, на какой стадии разработки осуществляется проверка системы <br> в реальных условиях:',
        right: [1],
        type: 1,
        points: 100,
        answers: ['анализ требований', 'развертывание', 'тестирование', 'проектирование',],
    },
];
